...
func drop_slot_data(grabbed_slot_data: SlotData, index: int)->SlotData:
	if not grabbed_slot_data.item_data.itemSlottype == itemData.itemSlotType.Feet:
...
func grab_slot_data(index: int)->SlotData:
	...
	if slot_data and slot_data.item_data.itemSlottype == itemData.itemSlotType.Feet:
